...
public class SavedNewsActivity extends AppCompatActivity {
    ...
    protected void onCreate( final Bundle savedInstanceState) {
        ...
        Query mHouseDatabaseReference2 =mFirebaseDatabase.getReference().child("SaveNews");
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    for (DataSnapshot issue : dataSnapshot.getChildren()) {
                        ...
                        System.out.println(issue.child("newsTitle").getValue());
                      //  System.out.println("lala : "+issue.child("text").getValue());
                        if(username.equals(issue.child("username").getValue().toString())) {
                            status[messageCount] = issue.child("newsTitle").getValue().toString();
                            messageCount++;
                        }
                    ...
                    speak2("There are total "+messageCount+" save news! single tab to check it!");
