...
public class GuidelinesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(count1==0) {
            handler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    final MediaPlayer mp = MediaPlayer.create(GuidelinesActivity.this, R.raw.intro);
            ...
            handler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    if(count1==1) {
                        MediaPlayer mPlayer = MediaPlayer.create(GuidelinesActivity.this, R.raw.second);
                        mPlayer.start();
                    }

                    else if(count1==2){
                        MediaPlayer mPlayer = MediaPlayer.create(GuidelinesActivity.this, R.raw.third);
                        mPlayer.start();
                    }
                    else if(count1==3)
                    {
                        MediaPlayer mPlayer = MediaPlayer.create(GuidelinesActivity.this, R.raw.fourth);
                        mPlayer.start();
                    }
                    else if(count1==4)
                    {
                        MediaPlayer mPlayer = MediaPlayer.create(GuidelinesActivity.this, R.raw.fifth);
                        mPlayer.start();
                    }
                    else if(count1==5)
                    {
                        MediaPlayer mPlayer = MediaPlayer.create(GuidelinesActivity.this, R.raw.sixth);
                        mPlayer.start();
                    }
                    else
                    {
                        MediaPlayer mPlayer = MediaPlayer.create(GuidelinesActivity.this, R.raw.seven);
                        mPlayer.start();
                    }
    ...
    public void onSwipeBottom() {
        ...
        if(count1==6) {
            ...
            MediaPlayer mPlayer = MediaPlayer.create(GuidelinesActivity.this, R.raw.eight);
            mPlayer.start();

            finish();
            Intent i = new Intent(GuidelinesActivity.this,OneHandedBrailleKeyboard.class);
            startActivity(i);
