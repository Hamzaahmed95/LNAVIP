...
public class SportsNewsAPI {
    ...
    public static final String TAG ="SportsNewsAPI";
    ...
    public List<NewsItem> fetchItems(int count){
        ...
        try {
            if(count==1) {
                url = Uri.parse("https://newsapi.org/v2/top-headlines?sources=espn&apiKey=03b903f9d9bb433eb25cb8369dcc138b")
                        .buildUpon()
                ...
                url = Uri.parse("https://newsapi.org/v2/top-headlines?sources=entertainment-weekly&apiKey=03b903f9d9bb433eb25cb8369dcc138b   ")
                        .buildUpon()
                        .appendQueryParameter("method", "flickr.photos.getRecent")
                        .appendQueryParameter("api_key", API_KEY)
                        .appendQueryParameter("format", "json")
                ...
                url = Uri.parse("https://newsapi.org/v2/top-headlines?sources=cnn&apiKey=03b903f9d9bb433eb25cb8369dcc138b")
                        .buildUpon()
                        .appendQueryParameter("method", "flickr.photos.getRecent")
                        .appendQueryParameter("api_key", API_KEY)
                        .appendQueryParameter("format", "json")
                ...
                url = Uri.parse("https://newsapi.org/v2/top-headlines?sources=techcrunch&apiKey=03b903f9d9bb433eb25cb8369dcc138b")
                        .buildUpon()
                        .appendQueryParameter("method", "flickr.photos.getRecent")
                        .appendQueryParameter("api_key", API_KEY)
                        .appendQueryParameter("format", "json")
