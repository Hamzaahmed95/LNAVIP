...
public class NumberClass extends AppCompatActivity {
    ...
    public void onSwipeTop() {
        Toast.makeText(NumberClass.this, "top", Toast.LENGTH_SHORT).show();
        speak1("Clear");
        name="";
        textView.setText(name);
        count1=0;
    ...
    public void onSwipeRight() {
        ...
        //  Toast.makeText(NumberClass.this, "right", Toast.LENGTH_SHORT).show();
        Intent i =new Intent(NumberClass.this,OneHandedBrailleKeyboard.class);
        startActivity(i);
    }
    public void onSwipeLeft() {
        Toast.makeText(NumberClass.this, "left", Toast.LENGTH_SHORT).show();
        if(name.equals("")){
            ...
            Intent i = new Intent(NumberClass.this,ConfirmationActivity3.class);
            i.putExtra("ActivityName","NumberClass");
    ...
    public void onSwipeBottom() {
            Toast.makeText(NumberClass.this, "bottom", Toast.LENGTH_SHORT).show();
        speak1("space");
    }
