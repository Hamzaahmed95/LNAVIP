...
public class SportsNews extends Fragment {
    ...
    int count=0;
    String title;
    public static SportsNews newInstance(){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle s){
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                speak2(newsName+" News on the Screen now! Just single tap on the screen to play the news!");
    ...
    private class FetchItemsTask extends AsyncTask<Void,Void,List<NewsItem>> {
        ...
        protected List<NewsItem>  doInBackground(Void... params){
            ...
            if(username.equals("Sports")){
                newsName="Sports";
                count=1;
            }
            else if (username.equals("Entertainment")){
                newsName="Entertainment";
                count=2;
            }
            ...
            return new SportsNewsAPI().fetchItems(count);
